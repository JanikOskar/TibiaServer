...
export const DBZMissions = () => {
  ...
  const BuuSagaDataSource = [
    {
      ...
      level: "150",
      mission:
        "Talk with Kaioshin on Budokai, next Go to Babidis Ship and Kill Majin Monsters and Talk with Kaioshin.",
      exp: "750.000",
  ...
  return (
    <MainMenu>
      ...
      <SagaTitle>Saiyan Saga</SagaTitle>
      <TableStyle
        dataSource={SaiyanSagaDataSource}
        columns={columns}
        pagination={false}
        onRow={() => ({
          style: {
      ...
      />
      <SagaTitle>Freeza Saga</SagaTitle>
      <TableStyle
        dataSource={FreezaSagaDataSource}
        columns={columns}
        pagination={false}
        onRow={() => ({
          style: {
      ...
      />
      <SagaTitle>Cell Saga</SagaTitle>
      <TableStyle
        dataSource={CellSagaDataSource}
        columns={columns}
        pagination={false}
        onRow={() => ({
          style: {
      ...
      />
      <SagaTitle>Buu Saga</SagaTitle>
      <TableStyle
        dataSource={BuuSagaDataSource}
        columns={columns}
        pagination={false}
        onRow={() => ({
          style: {
